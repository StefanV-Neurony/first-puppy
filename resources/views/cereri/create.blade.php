@extends('layouts.app')
@section('content')
    <h1 class="chestionar-title">Chestionar adoptie animal - create </h1>
    <div class="container-create-cerere">
{{ Html::ul($errors->all()) }}

{{ Form::open(array('route' => array('cereri.store'), 'method' => 'POST', 'class' => 'form-create-cerere'))}}
...
<div class="form-group">
        ...
        <div class="form-group">
            ...
            {{ Form::select('inputAmbient', array('0' => 'Activ', '1' => 'Galagios' , '2'=> 'Linistit', '3'=> 'Uzual'), null, array('class' => 'form-control')) }}
        </div>
        <div class="form-group">
       ...
       <div class="form-group">
        ...
        {{ Form::submit('Adopta-ma!', array('class' => 'btn btn-primary')) }}
